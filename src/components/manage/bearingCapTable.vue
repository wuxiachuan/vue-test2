                ...
                <el-card>
                    <el-form>
                        ...
                        <el-row>
                            ...
                            <el-col :span="7">
                                <el-form-item label="关盖作业" prop="caperLeft" label-width="120px">
                                    <el-input v-model="ruleForm.caperLeft" placeholder="左" :disabled="enableLeft"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="4">
