        ...
        <el-card>
            <el-row :gutter="5">
                <el-form :model="searchProblem"  ref="problemForm" >
                    ...
                    <el-col :span="4">
                        <el-button size="small" type="primary" @click="searchforProblem('problemForm')" >查询</el-button>
                        <el-button size="small" @click="resetSearchProblemCond('problemForm')" >重置</el-button>
                    </el-col>
                </el-form>
            </el-row>
        ...
        methods: {
            ...
            async searchProblemCond(page,size){
                var result = await axios.post(
                    "http://localhost:8081/spt2/quality/findProblemCondPage?page="
                    +page+"&size="+size,
                    this.searchProblem);
